...
| java              | runtime           | asdf                             | asdf                   | asdf                  | `java --version`                                                                 |
| kotlin            | runtime           | asdf                             | asdf                   | asdf                  | `kotlin -version`                                                                |
| gradle            | build             | asdf                             | asdf                   | asdf                  | `gradle --version`                                                               |
| maven             | build             | asdf                             | asdf                   | asdf                  | `mvn --version`                                                                  |
| nodejs            | runtime           | asdf                             | asdf                   | asdf                  | `node --version`                                                                 |
| npm               | runtime           | asdf                             | asdf                   | asdf                  | `npm --version`                                                                  |
| terraform         | infra             | asdf                             | asdf                   | asdf                  | `terraform --version`                                                            |
| opentofu          | infra             | asdf                             | asdf                   | asdf                  | `tofu --version`                                                                 |
| go                | runtime           | asdf                             | asdf                   | asdf                  | `go version`                                                                     |
| erlang            | runtime           | asdf                             | asdf                   | asdf                  | `erl -eval 'erlang:display(erlang:system_info(otp_release)), halt().'  -noshell` |
| elixir            | runtime           | asdf                             | asdf                   | asdf                  | `elixir --version`                                                               |
| gleam             | runtime           | asdf                             | asdf                   | asdf                  | `gleam --version`                                                                |
| docker            | containers        | pacman                           | apt                    | brew+colima           | `docker --version`                                                               |
| docker compose    | containers        | pacman (`docker-compose` plugin) | apt plugin             | brew plugin           | `docker compose version`                                                         |
| rust (rustup)     | runtime           | vendor-script                    | vendor-script          | vendor-script/brew    | `rustc --version`                                                                |
| uv                | python tooling    | vendor-script                    | vendor-script          | brew/vendor           | `uv --version`                                                                   |
| python            | runtime           | uv-managed                       | uv-managed             | uv-managed            | `python3 --version`                                                              |
| flatpak           | app platform      | pacman                           | apt                    | brew/manual           | `flatpak --version`                                                              |
| keepassxc         | security/password | flatpak                          | flatpak                | brew-cask             | `keepassxc --version`                                                            |
| obsidian          | notes             | flatpak                          | flatpak                | manual                | app exists                                                                       |
| onlyoffice        | office            | flatpak                          | flatpak                | manual                | app exists                                                                       |
